                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: Padding(
                              ...
                              child:
                                  (!isloading && CacheHelper.getSliderOpened())
                          ...
                          // SLOT 4: مساحة بسيطة مريحة أسفل المحتوى
                          SizedBox(height: 4.h),
                        ],
                      );
                    },
              ...
              if (CacheHelper.getSlidesEnabled())
                Container(
                  child: RotatingAyahBanner(
                    maxLines: 3,
                    ayat:
                        (AppCubit().todaysSlides != null &&
                            AppCubit().todaysSlides!.isNotEmpty)
                        ? AppCubit().todaysSlides!.map((e) => e.text).toList()
                        : ayat,
                    height: 140.h,
                    maxFontSize: 22.sp,
                    minFontSize: 12.sp,
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        return Column(
          children: [
            _InfoBlock(cubit: cubit),
            SizedBox(height: 10.h),

            // SizedBox(height: gap),
            _BigCountdownPanel(nextPrayerFuture: nextPrayerFuture),
            SizedBox(height: 10.h),
...
class _InfoBlock extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final weekday = LocalizationHelper.isArabic()
    ...
    return Column(
      ...
      children: [
        ...
        GestureDetector(
          ...
          child: _infoLine(LocaleKeys.hijri_date.tr(), hijri),
        ),
        SizedBox(height: 6.h),
      ...
      child: SizedBox(
        ...
        child: PageView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            final displayText = widget.wrapWithBrackets ? "﴿ $text ﴾" : text;
            return Padding(
